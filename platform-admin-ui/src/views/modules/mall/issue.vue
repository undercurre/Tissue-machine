  ...
  <div class="mod-issue">
    ...
    <el-table
      ...
      <el-table-column
        ...
        label="反馈图片">
        <template slot-scope="scope">
          <img style="width: 100px; height: 100px; display: inline-block;" v-for="item in scope.row.adIssueImageEntityList" :key="item.id" :src="item.imageUrl" @click="openImg(item.imageUrl)" lazy></img>
        </template>
      </el-table-column>
      <el-table-column
        prop="createTime"
