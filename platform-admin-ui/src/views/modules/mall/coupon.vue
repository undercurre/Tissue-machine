  ...
  <div class="mod-coupon">
    <el-form :inline="true" :model="searchForm" @keyup.enter.native="getDataList(1)">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('ad:coupon:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>
        <el-button v-if="isAuth('ad:coupon:delete')" type="danger" @click="deleteHandle()"
...
<!--      </el-table-column>-->
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button v-if="isAuth('ad:coupon:sendUser') && scope.row.status === 1" type="text"
      ...
      <el-table-column
        ...
        label="操作">
        <template slot-scope="scope">
          <el-button v-if="isAuth('ad:coupon:info')" type="text" size="small" @click="showDetails(scope.row.id)">查看
          </el-button>
          <el-button v-if="isAuth('ad:coupon:update')" type="text" size="small"
                     @click="addOrUpdateHandle(scope.row.id)">修改
          </el-button>
<!--          <el-button v-if="isAuth('ad:coupon:delete')" type="text" size="small" @click="deleteHandle(scope.row.id)">-->
<!--            删除-->
<!--          </el-button>-->
        </template>
      </el-table-column>
...
<script>
  ...
  export default {
    ...
    activated () {
      this.getDataList()
      this.$http({
        url: '/mall/user/selectMallUserByAgent',
        method: 'get',
        params: {
